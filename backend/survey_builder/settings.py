"""
Django settings for survey_builder project.
...
INSTALLED_APPS = [
    ...
    'surveys',  # Add your surveys app here
]
...
ROOT_URLCONF = 'survey_builder.urls'
...
WSGI_APPLICATION = 'survey_builder.wsgi.application'
